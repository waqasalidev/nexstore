...
const DialogContent = /*#__PURE__*/React.forwardRef(
  ...
  _jsxs(DialogPortal, { children: [/*#__PURE__*/
    ...
    _jsxs(DialogPrimitive.Content, {
      ...
      children, /*#__PURE__*/
      _jsxs(DialogPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background cursor-pointer transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground", children: [/*#__PURE__*/
